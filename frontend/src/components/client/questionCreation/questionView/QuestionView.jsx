...
const cleanMathJaxHTML = (html = "") =>
  html
    .replace(/<strong[^>]*>|<\/strong>/gi, "")
    .replace(/<b[^>]*>|<\/b>/gi, "")
    .replace(/<\/?span[^>]*>/gi, "")

    // ⚠️ ORDER MATTERS (biggest fix)
    .replace(/iii\.\s*/gi, "<br/>iii. ")
    .replace(/ii\.\s*/gi, "<br/>ii. ")
    .replace(/i\.\s*/gi, "<br/>i. ")

    .replace(/(নিচের কোনটি সঠিক\?)/gi, "<br/><br/>$1")
    .replace(/(জ্ঞান)/gi, "<br/><br/><strong>$1</strong>")
  ...
  return (
    ...
    >
     ...
     <div className="sticky top-0 z-20 bg-white p-2 shadow-md rounded-xl">
    ...
    <div className="flex items-center gap-2 ">
      <div className="md:hidden">
        <Button
          ...
          className="bg-[#024645] text-white p-2 rounded-full shadow-lg"
          size="icon"
...
<div
  className="
    absolute left-1/3 -translate-x-1/2
  ...
  <Chip className="bg-[#024645] text-white" variant="shadow">
    ...
    <div className="ml-auto flex items-center gap-2">
      ...
      <Tooltip
        ...
        content={<p className="text-lg">আপনার সংগ্রহকৃত প্রশ্নগুলো দেখুন</p>}
      >
        <Button
          size="sm"
...
<MathJaxContext config={mathjaxConfig}>
  <MathJax dynamic>
    <div
      ...
      dangerouslySetInnerHTML={{
        __html: sanitizeHtml(
          cleanMathJaxHTML(question?.questionName || ""),
          sanitizeConfig
        ),
      }}
    />
