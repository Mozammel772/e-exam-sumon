...
export default function ShortQusView() {
  ...
  return (
    <div
      className={` ${
        size?.width <= 600
          ? "solaimanlipi flex flex-col md:flex-row  mt-[85px] p-0 w-[480px]"
            ...
            <div className="flex flex-col overflow-hidden">
              ...
              {currentQuestions.map((question, index) => {
                ...
                return (
                  <div
                    key={question._id}
                    className={`mb-4 relative p-4 border-2 rounded-xl cursor-pointer transition-all duration-300 overflow-hidden ${
                      isSelected
                  ...
                  >
                    ...
                    <div className="flex items-start justify-center">
                      ...
                      <div className=" flex items-center justify-center text-black font-medium text-lg mt-1 md:mt-2 ">
                        {toBanglaNumber(
                          ...
                          <div className="flex flex-col md:flex-row justify-between items-start md:items-center  pb-4">
                                ...
                                <LatexRenderer
                                  content={
                                    question.type === "CQ"
                                      ...
                                      : question.type === "short"
                                      ? question.shortQusDetails?.shortQuestion
                                      : question.questionName
                                  }
                                />
                              </div>
                            ...
                            <div className="flex justify-center items-center flex-wrap gap-2">
                              {question?.boardExamList?.map((board) => (
                                <p
                                  key={board}
                                  className="text-gray-600 text-xs md:text-lg font-medium"
                                >
                                  {board}
                                </p>
                              ))}
    ...
    {search}
                            ...
                            <div className="space-y-4 mt-1 md:mt-2">
                              ...
                              {question.cqDetails?.question1 && (
                                <div className="text-gray-700">
                                  <h3 className="text-lg  mb-2 flex flex-row items-center gap-1">
                                    ক.{" "}
                          ...
                          {question.type === "MCQ" && (
                            <div className="mt-2 md:mt-4">
                              <div className="grid grid-cols-2 gap-1 md:gap-4">
                                {question.option1 && (
                                  <p className="p-0  flex flex-row items-center">
                                    <strong className="me-2 font-medium">ক. </strong>
                                    <span className="text-gray-700 leading-relaxed">
                                      <LatexRenderer
                                ...
                                {question.option2 && (
                                  <div className="p-0  flex flex-row items-center">
                                    <strong className="me-2 font-medium">খ. </strong>
                                    <span className="text-gray-700 leading-relaxed">
                                      <LatexRenderer
                                ...
                                {question.option3 && (
                                  <div className="p-0  flex flex-row items-center">
                                    <strong className="me-2 font-medium">গ. </strong>
                                    <span className="text-gray-700 leading-relaxed">
                                      <LatexRenderer
                                ...
                                {question.option4 && (
                                  <div className="p-0  flex flex-row items-center">
                                    <strong className="me-2 font-medium">ঘ. </strong>
                                    <span className="text-gray-700 leading-relaxed">
                                      <LatexRenderer
      ...
      (size?.width > 600 && shouldShowSidebar) ? (
        <>
          ...
          <div
            ref={sidebarRef}
            className={`h-screen w-[300px] lg:w-[350px] bg-white shadow-lg z-50 transform transition-transform duration-500 ease-in-out
        ${
          size?.width <= 600
                  ...
                  <div className="space-y-2 max-h-40 overflow-y-auto">
                    {availableChapters.map((chapter) => (
                      <div key={chapter.key}>
                        ...
                        >
                          <p className="text-lg">{chapter.label}</p>
                        </Checkbox>
                      </div>
                    ))}
                  </div>
...
//       className={` ${
//         size?.width <= 600
//           ? "solaimanlipi flex flex-col md:flex-row  mt-[85px] p-5"
//           : "solaimanlipi flex flex-col md:flex-row ms-[255px] mt-[85px] p-5 gap-5"
//       }`}
//     >
//       {/* Filter Button for Mobile */}
...
//                       {/* Question Number Circle */}
//                       <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
//                         {toBanglaNumber(
//                           (currentPage - 1) * questionsPerPage + index + 1
//                         )}
//                       </div>
...
//                       <div className="bg-gray-100 flex items-center justify-center w-full">
//                         <div className="bg-white rounded-lg ps-3 pe-3 w-full">
//                           {/* Chapter Name */}
//                           <div className="mb-3">
//                             <Chip color="primary" variant="flat">
//                               <span className="font-semibold">
...
//                               <div className="text-gray-700 leading-relaxed text-xl font-semibold">
//                                 <LatexRenderer
//                                   content={
//                                     question.type === "CQ"
//                                       ? question.cqDetails?.mainQuestion
...
//                                 {question.option1 && (
//                                   <p className="p-3 border rounded-md bg-gray-50 flex flex-row items-center">
