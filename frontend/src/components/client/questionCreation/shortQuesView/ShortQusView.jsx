...
//               content={
//                 <p className="text-base md:text-xl">আপনার সংগ্রহকৃত প্রশ্নগুলো দেখুন</p>
//               }
//             >
//               <Button
//                 size="sm"
...
//                       <div className=" flex items-center justify-center text-black font-medium text-base md:text-xl mt-1 md:mt-2 ">
//                         {toBanglaNumber(
...
//                                 <p
//                                   key={board}
//                                   className="text-gray-600 text-xs md:text-base md:text-xl font-medium"
//                                 >
//                                   {board}
//                                 </p>
//                               ))}
...
//                                 )}
//                                 {question.option2 && (
//                                   <div className="p-2 md:p-3 border rounded-md bg-gray-50 flex flex-row items-center">
...
//                           }
//                         >
//                           <p className="text-base md:text-xl">{chapter.label}</p>
//                         </Checkbox>
//                       </div>
//                     ))}
//                   </div>
...
export default function ShortQusView() {
  ...
  return (
    <div
      className={` ${
        size?.width <= 600
          ? "solaimanlipi flex flex-col md:flex-row  mt-[85px] p-2 w-[480px]"
          : "solaimanlipi flex flex-col md:flex-row ms-[255px] mt-[85px] p-5 gap-5"
      }`}
    >
      <Card className="flex-1 max-h-[100vh] overflow-y-auto relative p-4">
      ...
      (size?.width > 600 && shouldShowSidebar) ? (
        <>
          ...
          <div
            ref={sidebarRef}
            className={`h-screen w-[350px] lg:w-[350px] bg-white shadow-lg z-50 transform transition-transform duration-500 ease-in-out
        ${
          size?.width <= 600
            ? "translate-x-0 fixed top-0 right-0"
            : "translate-x-0"
