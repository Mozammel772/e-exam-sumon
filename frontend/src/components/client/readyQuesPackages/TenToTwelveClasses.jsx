...
export default function TenToTwelveClasses() {
  ...
  return (
    <div className="ms-[275px] me-[20px] mt-20 solaimanlipi pb-5">
      <div className="bg-gradient-to-r from-amber-100 to-orange-50 py-6 mt-6">
        <p className="text-center font-bold solaimanlipi text-orange-700 text-5xl mt-5">
          রেডি প্রশ্ন প্যাকেজ: দশম - দ্বাদশ শ্রেণী পর্যন্ত
        </p>
      </div>
